        ...
        <div className="space-y-8 pb-10">
            ...
            <div className="flex items-center justify-between sticky top-[4rem] z-20 bg-background/90 backdrop-blur-md py-4 -mx-6 px-6 border-b border-border/50">
                <div>
                    ...
                    <p className="text-muted-foreground text-sm">Manage physical spaces, rooms, and beds</p>
                </div>
                <Button
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                <MagicCard className="bg-card border border-border shadow-sm" gradientColor="hsl(var(--info) / 0.2)">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">Stored Locations</p>
                    </CardContent>
                </MagicCard>
                ...
                <MagicCard className="bg-card border border-border shadow-sm" gradientColor="hsl(var(--success) / 0.2)">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-green-600 mt-1 font-medium">In Use</p>
                    </CardContent>
                </MagicCard>
                ...
                <MagicCard className="bg-card border border-border shadow-sm" gradientColor="hsl(217 91% 60% / 0.2)">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-indigo-600 mt-1 font-medium">Medical Units</p>
                    </CardContent>
                </MagicCard>
                ...
                <MagicCard className="bg-card border border-border shadow-sm" gradientColor="hsl(142 76% 36% / 0.2)">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-teal-600 mt-1 font-medium">OPD Rooms</p>
                    </CardContent>
                </MagicCard>

                <MagicCard className="bg-card border border-border shadow-sm" gradientColor="hsl(47 95% 57% / 0.2)">
                    <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                        <CardTitle className="text-sm font-medium text-muted-foreground">Wards</CardTitle>
                        <Bed className="w-4 h-4 text-amber-600" />
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-bold text-foreground">{stats.wards}</div>
                        <p className="text-xs text-amber-600 mt-1 font-medium">Inpatient</p>
                    </CardContent>
                </MagicCard>
                ...
                <MagicCard className="bg-card border border-border shadow-sm" gradientColor="hsl(var(--destructive) / 0.2)">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-red-500 mt-1 font-medium">Closed/Maint</p>
                    </CardContent>
                </MagicCard>
            </div>
