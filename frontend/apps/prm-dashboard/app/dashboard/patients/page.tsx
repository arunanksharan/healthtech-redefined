        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <MagicCard className="bg-card border border-border shadow-sm" gradientColor="hsl(var(--warning) / 0.15)">
            ...
            <CardContent>
              ...
              <p className="text-xs text-amber-600 dark:text-amber-400 mt-1 font-medium">Years old</p>
            </CardContent>
          </MagicCard>
        </div>
              ...
              <Table>
                <TableHeader className="bg-muted/50">
                  <TableRow className="hover:bg-transparent">
                    ...
                    <TableHead className="font-semibold text-muted-foreground">Contact Info</TableHead>
                    <TableHead className="font-semibold text-muted-foreground">MRN</TableHead>
                    <TableHead className="font-semibold text-muted-foreground">Date of Birth</TableHead>
                ...
                <TableBody>
                  {patients.map((patient) => (
                    <TableRow key={patient.id} className="hover:bg-blue-50/30 dark:hover:bg-blue-900/10 transition-colors group">
                      <TableCell>
                        <div className="flex items-center gap-3">
