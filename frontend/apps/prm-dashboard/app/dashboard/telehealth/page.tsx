            ...
            <Card className="w-full max-w-lg bg-white dark:bg-gray-800 border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-lg">
                <CardContent className="flex flex-col items-center justify-center py-16 px-8 text-center">
                    ...
                    <div className="relative mb-6">
                        <div className="w-20 h-20 rounded-lg bg-emerald-50 dark:bg-emerald-900/20 border-2 border-emerald-200 dark:border-emerald-800 flex items-center justify-center">
                    ...
                    {/* Title */}
                    <h1 className="text-2xl font-heading text-gray-900 dark:text-white mb-2">Telehealth Platform</h1>
